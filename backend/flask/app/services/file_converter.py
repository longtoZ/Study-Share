...
def pdf_to_webp(pdf_path, output_dir, quality = 20):
    """
    ...
    try:
        ...
        raise RuntimeError(f"An error occurred during PDF to WebP conversion: {e}")
...
def docx_to_pdf(docx_path, output_dir):
    ...
    try:
        ...
        raise RuntimeError(f"An error occurred during DOCX to PDF conversion: {e}")