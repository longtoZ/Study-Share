import type { Statistic, MaterialExtended, LessonExtended} from '@interfaces/userProfile.d'
import type { Subject } from '@interfaces/table.d';
import { ENDPOINTS } from '@/constants/endpoints';

const USER_PROFILE_ENDPOINT = ENDPOINTS.USER_PROFILE;
const USER_STATISTICS_ENDPOINT = ENDPOINTS.USER_STATISTICS;
const USER_MATERIALS_ENDPOINT = ENDPOINTS.USER_MATERIALS;
const USER_LESSONS_ENDPOINT = ENDPOINTS.USER_LESSONS;
const SUBJECTS_ENDPOINT = ENDPOINTS.GET_ALL_SUBJECTS;
const SIGNUP_ENDPOINT = ENDPOINTS.SIGNUP;
const LOGIN_ENDPOINT = ENDPOINTS.LOGIN;
const CHECK_EMAIL_ENDPOINT = ENDPOINTS.CHECK_EMAIL;
const VERIFY_EMAIL_ENDPOINT = ENDPOINTS.VERIFY_EMAIL;
