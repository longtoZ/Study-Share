    ...
    return (
        <div className='mt-4'>
            {materials.map((_, index) => (
                <div key={index} 
                    className='p-4 my-4 border-2 border-zinc-200 rounded-xl cursor-pointer transition-all ease-in-out duration-200 hover:border-blue-600 hover:shadow-lg hover:scale-[101%] flex justify-between items-center'
