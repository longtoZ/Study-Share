...
const LessonsGrid = ({ lessons }: { lessons: Lesson[]}) => {
    ...
    return (
        <div className='grid grid-cols-3 gap-4 mt-4'>
            {lessons.map((_, index) => (
                <div key={index} 
                    className='p-4 my-2 border-2 border-zinc-200 rounded-lg cursor-pointer hover:border-blue-600 hover:shadow-lg hover:scale-[101%] transition-all ease-in-out duration-200 flex justify-between'
                    ...
                    <div className=' w-[75%]'>
                        ...
                        <div className='mt-2 flex justify-between items-center'>
                            <div className='w-full'>
                                <p className='text-subtitle-secondary'>
                                ...
                                <p className='text-subtitle-secondary mt-2'>
